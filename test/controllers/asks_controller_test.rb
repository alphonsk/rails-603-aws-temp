...
class AsksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ask" do
    assert_difference('Ask.count') do
      post asks_url, params: { ask: { apartment_id: @ask.apartment_id, message: @ask.message, user_id: @ask.user_id } }
    end
  ...
  test "should update ask" do
    patch ask_url(@ask), params: { ask: { apartment_id: @ask.apartment_id, message: @ask.message, user_id: @ask.user_id } }
